                          ...
                          Container(
                            ...
                            child: ExpansionTile(
                              ...
                              children: [
                                ...
                                Consumer<LocalizationProvider>(builder: (context, localizationProvider,child){
                                  return ListTile(
                                    leading: Icon(
                                            ...
                                            Transform.scale(
                                              ...
                                              child: Switch(
                                                  ...
                                                  inactiveThumbColor:
                                                      CommonColor
                                                          .mediumGreyColor,
                                                value:localizationProvider.locale.languageCode == "ja",
                                                 onChanged: (bool isJapanese) async {
                    String newLanguage = isJapanese ? "ja" : "en"; // Toggle language
                    localizationProvider.setLocale(Locale(newLanguage)); // Update language
                  },
),
                                            ),
                                            Text("Jap"),
