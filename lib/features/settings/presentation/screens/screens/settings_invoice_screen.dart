...
// class SettingsInvoiceScreen extends StatelessWidget {
...
class SettingsInvoiceScreen extends StatefulWidget {
  const SettingsInvoiceScreen({super.key});

  @override
  State<SettingsInvoiceScreen> createState() => _InvoiceScreenState();
}

class _InvoiceScreenState extends State<SettingsInvoiceScreen> {
  @override
  void initState() {
