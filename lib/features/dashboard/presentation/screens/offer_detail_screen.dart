...
class OfferDetailScreen extends StatefulWidget {
  final String sku;
  const OfferDetailScreen({super.key, required this.sku});

  @override
  State<OfferDetailScreen> createState() => _ProductDetailScreenState();
}

class _ProductDetailScreenState extends State<OfferDetailScreen> {
