...
//                               itemCount: invoiceProvider.filteredOrders.length+1,
//                               itemBuilder: (context, index) {

//                                 if (index < invoiceProvider.filteredOrders.length){
//  final order =
//                                     invoiceProvider.filteredOrders[index];
...
//                                 );
//                                 } else {
//                                   return invoiceProvider.isGetAllOrderLoading
//                                       ? Center(
//                                           child: Padding(
...
//                                           ),
//                                         )
//                                       : Text("No more invoice to load!"); // Hide if no more data
//                                 }
